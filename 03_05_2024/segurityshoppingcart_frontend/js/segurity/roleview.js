...
function loadData() {
    ...
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/roleView",
        method: "GET",
        dataType: "json",
...
function deleteById(id) {
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/roleView/" + id,
        method: "delete",
        headers: {
...
function findById(id) {
    $.ajax({
        ...
        success: function (response) {
            var data = response.data;
            $("#view").val(data.view.name);
            $("#view_id").val(data.view.id);
    ...
    try {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                alert("Registro agregado con éxito: " + data.id);
                clearData();
                loadData();
                $("#modal").hide();
            },
