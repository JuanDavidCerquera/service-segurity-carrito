...
function loadData() {
    ...
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/suppliesproduct",
        method: "GET",
        dataType: "json",
...
function deleteById(id) {
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/suppliesproduct/" + id,
        method: "delete",
        headers: {
...
function findById(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#supplies").val(data.supplies.name);
            $("#supplies_id").val(data.supplies.id);
            $("#unitmeasure").val(data.unitmeasure.name);
            $("#unitmeasure_id").val(data.unitmeasure.id);
...
function save() {
    try {
        var Data = {
            ...
            "supplies": { "id": $("#supplies_id").val(), },
            "unitmeasure": { "id": $("#unitmeasure_id").val(), },
            "state": true
        };
