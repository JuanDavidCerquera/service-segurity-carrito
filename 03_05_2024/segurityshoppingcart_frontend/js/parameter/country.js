...
function deleteById(id) {
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/country/" + id,
        method: "delete",
        headers: {
...
function findById(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#name").val(data.name);
            $("#code").val(data.code);
            $("#continent").val(data.continent.name);
            $("#continent_id").val(data.continent.id);
