...
function loadData() {
    ...
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/neighborhood",
        method: "GET",
        dataType: "json",
...
function deleteById(id) {
    $.ajax({
        url: "http://localhost:9000/service-segurity-carrito/v1/api/neighborhood/" + id,
        method: "delete",
        headers: {
